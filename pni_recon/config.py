...
if (socket.gethostname() == 'Lucys-MacBook-Pro-3.local') or (socket.gethostname() == 'vertex.kiewit.dartmouth.edu') or (socket.gethostname() == 'vertex.local'):
    config['datadir'] = '/Users/lucyowen/Desktop/supereeg_env/pni_bo/'
    config['workingdir'] = '/Users/lucyowen/Desktop/supereeg_env/pni_recon/'
    ...
    config['datadir'] = '/idata/cdl/lowen/pni_bo'
    config['workingdir'] = '/idata/cdl/lowen/pni_recon'
...
# runtime options
config['jobname'] = "pni_recon"  # default job name
