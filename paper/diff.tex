...
%DIF DEL rev1.tex   Wed Apr 15 17:29:48 2020
%DIF ADD main.tex   Tue Apr 14 23:36:44 2020
...
\DIFdelbegin \DIFdel{Taken together, the frequency-specific information maps suggest a potential new
...
%DIFDELCMD < %%%
\DIFdelend \section*{Discussion} Are our brain's networks static or dynamic?  And to what
...
work indicates that task-specific functional \DIFdelbegin \DIFdel{connectivity }\DIFdelend \DIFaddbegin \DIFadd{activations }\DIFaddend may be predicted by
...
task-dependent changes~\citep[e.g., ][]{SporBetz16}.  \DIFaddbegin \DIFadd{This prior work differs
...
above chance\DIFaddbegin \DIFadd{.
}

\DIFadd{Another important finding is that SuperEEG-based reconstructions accurately
