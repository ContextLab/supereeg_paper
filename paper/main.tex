...
This example confirms that the SuperEEG algorithm recovers the
recordings from this single electrode well.  Next, we used this
general approach to quantify the algorithm's performance across the
full dataset.
