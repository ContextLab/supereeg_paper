...
accuracy, and occipital electrodes tend to have relatively low
...
\begin{figure}
  ...
  \caption{\textbf{Most informative electrode locations.}
    ...
    MNI units of the given voxel.  {B. Dataset 2 information score by
...
patients-- even when compared to a correlation model trained using the
...
(as is currently done routinely), but also recordings collected from other
