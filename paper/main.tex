...
\begin{figure}
  ...
  positional distance~\citep[in MNI152 space;][]{LyttEtal07} according to an RBF. \textbf{C.~Per-patient
...
Figures~\ref{fig:corrmap}A and B indicate that many electrodes in the MTL (which
...
30--60 Hz; and $\gamma_H$: 60--100 Hz), along with a measure of broadband power.
We used second-order Butterworth bandpass filters to compute the activity
...
being particularly informative about one or more types of neural pattern.
...
\begin{figure}
  ...
  frequency band reflct the average across-subject reconstruction accuracies
  (Figs.~\ref{fig:corrmap}A, D).  The voxels in Panel A are colored according to
