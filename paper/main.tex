...
reconstruction accuracies for each electrode.  We found no reliable
correlations between reconstruction accuracy and density for either
dataset (Dataset 1: $r = 0.09, p = 0.44$; Dataset 2:
...
\begin{figure}
  ...
  \caption{\textbf{Most informative electrode locations.}
    ...
    Fig.~\intersectmap).  \textbf{C. Correspondence in information
