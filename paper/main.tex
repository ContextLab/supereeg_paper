...
anatomical and function correlations can differ
markedly~\citep[e.g.,][]{AdacEtal11, HoneEtal09, GoniEtal14}, we use temporal
...
large (e.g., for an example patient in Dataset 1, $T =
...
frequencies (peaking at $\alpha$) and worst at high frequencies.  
...
frequency. Lower frequency oscillations, such as delta, theta, and alpha, have
been posited to be processing modes which span large swaths of
...
area ~\citep{Nune95}, and are modulated by slow oscillations
...
of attention and visuo-motor ~\citep{MartiEtal10, MarzEtal13}, and we
similarly found a high proportion of visual and somatomotor networks
within this band.  We found $\beta$ intersections to predominantly
consist of somatomotor network, consistent with~\citep{RittEtal08,
  VanEEtal11}.  Also consistent with heavily cited
...
consistent with ~\{OssaEtal11}.  We then carried out a
meta analysis using Neurosynth~\citep{RubiEtal17} to identify the 5
terms most commonly associated with the given map
