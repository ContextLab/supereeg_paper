...
patients~\cite{SedeEtal03, SedeEtal07a, SedeEtal07b, MannEtal11,
  MannEtal12}.  Each recording session lasted from {0.2}--{3.0}
(total recording time: {0.3}--14.2 hours; Fig.~\suppstats A), and includes data from a list-learning memory experiment
...
activities.  For the purposes of the Dataset 1
...
of 40 epilepsy patients~\citep{EzzyEtal17, HoraEtal17, KragEtal17,
  ...
  KuceEtal18}.  Each recording session lasted from {0.4}--2.2 hours
(total recording time: {0.4}--6.6 hours; Fig.~\suppstats B).  Whereas Dataset 1 included recordings taken during a
