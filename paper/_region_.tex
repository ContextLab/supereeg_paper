...
closely ($r = 0.869, p = 10\textsuperscript{-10]$).  Figure~\ref{fig:recon}B displays a
...
electrode (correlation: $r = 0.909, p = 10\textsuperscript{-10}$).  This example confirms
...
\message{ !name(main.tex) !offset(-850) }
