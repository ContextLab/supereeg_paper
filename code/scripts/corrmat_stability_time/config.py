...
if (socket.gethostname() == 'Lucys-MacBook-Pro-3.local') or (socket.gethostname() == 'vertex.kiewit.dartmouth.edu') or \
    ...
    config['pyfrdatadir'] = '/Users/lucyowen/Desktop/supereeg_env/bo/'
    config['ramdatadir'] = '/Users/lucyowen/Desktop/supereeg_env/bo/'
    config['workingdir'] = '/Users/lucyowen/Desktop/supereeg_env/corrmat_stability_time/'
